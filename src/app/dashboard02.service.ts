...
export class Dashboard02Service {
  ...
  url="http://localhost:8082/api/v2/register";
  ...
  url2 : string="http://localhost:8082/api/v2/order/"+this.getemail();
  get() {
    alert(this.url2);
  ...
  url5: string="http://localhost:8082/api/v2/user/";
  ...
  addPizzas(data:pizzaClass){
    ...
    url9:string="http://localhost:8082/api/v2/delete/";
